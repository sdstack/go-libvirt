...
func (m *StorageVol) Delete(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StorageVol.Delete", 0, flags).Store()
	return
}
...
func (m *StorageVol) GetInfo(flags uint32) (info interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.StorageVol.GetInfo", 0, flags).Store(&info)
	return
}
...
func (m *StorageVol) GetXMLDesc(flags uint32) (xml string, err error) {
	err = m.conn.object.Call("org.libvirt.StorageVol.GetXMLDesc", 0, flags).Store(&xml)
	return
}
...
func (m *StorageVol) Resize(capacity uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StorageVol.Resize", 0, capacity, flags).Store()
	return
}
...
func (m *StorageVol) Wipe(pattern uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StorageVol.Wipe", 0, pattern, flags).Store()
	return
}
