...
func (m *Domain) AbortJob() (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.AbortJob", 0).Store()
	return
}
...
func (m *Domain) AddIOThread(iothreadId uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.AddIOThread", 0, iothreadId, flags).Store()
	return
}
...
func (m *Domain) AttachDevice(xml string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.AttachDevice", 0, xml, flags).Store()
	return
}
...
func (m *Domain) BlockCommit(disk string, base string, top string, bandwidth uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockCommit", 0, disk, base, top, bandwidth, flags).Store()
	return
}
...
func (m *Domain) BlockCopy(disk string, destxml string, params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockCopy", 0, disk, destxml, params, flags).Store()
	return
}
...
func (m *Domain) BlockJobAbort(disk string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockJobAbort", 0, disk, flags).Store()
	return
}
...
func (m *Domain) BlockPeek(disk string, offset uint64, size uint64, flags uint32) (buffer []byte, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockPeek", 0, disk, offset, size, flags).Store(&buffer)
	return
}
...
func (m *Domain) BlockPull(disk string, bandwidth uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockPull", 0, disk, bandwidth, flags).Store()
	return
}
...
func (m *Domain) BlockRebase(disk string, base string, bandwidth uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockRebase", 0, disk, base, bandwidth, flags).Store()
	return
}
...
func (m *Domain) BlockResize(disk string, size uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockResize", 0, disk, size, flags).Store()
	return
}
...
func (m *Domain) BlockJobSetSpeed(disk string, bandwidth uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.BlockJobSetSpeed", 0, disk, bandwidth, flags).Store()
	return
}
...
func (m *Domain) CoreDump(to string, dumpformat uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.CoreDump", 0, to, dumpformat, flags).Store()
	return
}
...
func (m *Domain) Create(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Create", 0, flags).Store()
	return
}
...
func (m *Domain) CreateWithFiles(files []uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.CreateWithFiles", 0, files, flags).Store()
	return
}
...
func (m *Domain) DelIOThread(iothreadId uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.DelIOThread", 0, iothreadId, flags).Store()
	return
}
...
func (m *Domain) Destroy(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Destroy", 0, flags).Store()
	return
}
...
func (m *Domain) DetachDevice(xml string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.DetachDevice", 0, xml, flags).Store()
	return
}
...
func (m *Domain) FSFreeze(mountpoints []string, flags uint32) (frozenFilesystems uint32, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.FSFreeze", 0, mountpoints, flags).Store(&frozenFilesystems)
	return
}
...
func (m *Domain) FSThaw(mountpoints []string, flags uint32) (thawedFilesystems uint32, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.FSThaw", 0, mountpoints, flags).Store(&thawedFilesystems)
	return
}
...
func (m *Domain) FSTrim(mountpoint string, minimum uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.FSTrim", 0, mountpoint, minimum, flags).Store()
	return
}
...
func (m *Domain) GetBlockIOParameters(flags uint32) (BlkioParameters map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetBlockIOParameters", 0, flags).Store(&BlkioParameters)
	return
}
...
func (m *Domain) GetBlockIOTune(disk string, flags uint32) (blockIOTune map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetBlockIOTune", 0, disk, flags).Store(&blockIOTune)
	return
}
...
func (m *Domain) GetBlockJobInfo(disk string, flags uint32) (blockJobInfo interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetBlockJobInfo", 0, disk, flags).Store(&blockJobInfo)
	return
}
...
func (m *Domain) GetControlInfo(flags uint32) (controlInfo interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetControlInfo", 0, flags).Store(&controlInfo)
	return
}
...
func (m *Domain) GetDiskErrors(flags uint32) (diskErrors []interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetDiskErrors", 0, flags).Store(&diskErrors)
	return
}
...
func (m *Domain) GetEmulatorPinInfo(flags uint32) (cpumap []uint, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetEmulatorPinInfo", 0, flags).Store(&cpumap)
	return
}
...
func (m *Domain) GetFSInfo(flags uint32) (fsInfo []interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetFSInfo", 0, flags).Store(&fsInfo)
	return
}
...
func (m *Domain) GetGuestVcpus(flags uint32) (vcpus map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetGuestVcpus", 0, flags).Store(&vcpus)
	return
}
...
func (m *Domain) GetHostname(flags uint32) (hostname string, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetHostname", 0, flags).Store(&hostname)
	return
}
...
func (m *Domain) GetInterfaceParameters(device string, flags uint32) (interfaceParameters map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetInterfaceParameters", 0, device, flags).Store(&interfaceParameters)
	return
}
...
func (m *Domain) GetIOThreadInfo(flags uint32) (ioThreadInfo []interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetIOThreadInfo", 0, flags).Store(&ioThreadInfo)
	return
}
...
func (m *Domain) GetJobInfo() (jobInfo interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetJobInfo", 0).Store(&jobInfo)
	return
}
...
func (m *Domain) GetJobStats(flags uint32) (stats interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetJobStats", 0, flags).Store(&stats)
	return
}
...
func (m *Domain) GetMemoryParameters(flags uint32) (memoryParameters map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetMemoryParameters", 0, flags).Store(&memoryParameters)
	return
}
...
func (m *Domain) GetMetadata(itype int32, uri string, flags uint32) (metadata string, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetMetadata", 0, itype, uri, flags).Store(&metadata)
	return
}
...
func (m *Domain) GetNumaParameters(flags uint32) (numaParameters map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetNumaParameters", 0, flags).Store(&numaParameters)
	return
}
...
func (m *Domain) GetPerfEvents(flags uint32) (perfEvents map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetPerfEvents", 0, flags).Store(&perfEvents)
	return
}
...
func (m *Domain) GetSchedulerParameters(flags uint32) (SchedulerParameters map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetSchedulerParameters", 0, flags).Store(&SchedulerParameters)
	return
}
...
func (m *Domain) GetSecurityLabelList() (securityLabels []interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetSecurityLabelList", 0).Store(&securityLabels)
	return
}
...
func (m *Domain) GetState(flags uint32) (state interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetState", 0, flags).Store(&state)
	return
}
...
func (m *Domain) GetStats(stats uint32, flags uint32) (records map[string]interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetStats", 0, stats, flags).Store(&records)
	return
}
...
func (m *Domain) GetTime(flags uint32) (time interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetTime", 0, flags).Store(&time)
	return
}
...
func (m *Domain) GetVcpuPinInfo(flags uint32) (vcpuPinInfo [][]uint, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetVcpuPinInfo", 0, flags).Store(&vcpuPinInfo)
	return
}
...
func (m *Domain) GetVcpus(flags uint32) (vcpus uint32, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetVcpus", 0, flags).Store(&vcpus)
	return
}
...
func (m *Domain) GetXMLDesc(flags uint32) (xml string, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.GetXMLDesc", 0, flags).Store(&xml)
	return
}
...
func (m *Domain) HasManagedSaveImage(flags uint32) (managedSaveImage uint, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.HasManagedSaveImage", 0, flags).Store(&managedSaveImage)
	return
}
...
func (m *Domain) InjectNMI(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.InjectNMI", 0, flags).Store()
	return
}
...
func (m *Domain) InterfaceAddresses(source uint32, flags uint32) (ifaces []interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.InterfaceAddresses", 0, source, flags).Store(&ifaces)
	return
}
...
func (m *Domain) ManagedSave(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.ManagedSave", 0, flags).Store()
	return
}
...
func (m *Domain) ManagedSaveRemove(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.ManagedSaveRemove", 0, flags).Store()
	return
}
...
func (m *Domain) MemoryPeek(offset uint64, size uint64, flags uint32) (buffer []byte, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MemoryPeek", 0, offset, size, flags).Store(&buffer)
	return
}
...
func (m *Domain) MemoryStats(flags uint32) (stats map[int32]uint64, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MemoryStats", 0, flags).Store(&stats)
	return
}
...
func (m *Domain) MigrateGetCompressionCache(flags uint32) (cacheSize uint64, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateGetCompressionCache", 0, flags).Store(&cacheSize)
	return
}
...
func (m *Domain) MigrateGetMaxSpeed(flags uint32) (bandwidth uint64, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateGetMaxSpeed", 0, flags).Store(&bandwidth)
	return
}
...
func (m *Domain) MigrateSetCompressionCache(cacheSize uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateSetCompressionCache", 0, cacheSize, flags).Store()
	return
}
...
func (m *Domain) MigrateSetMaxDowntime(downtime uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateSetMaxDowntime", 0, downtime, flags).Store()
	return
}
...
func (m *Domain) MigrateSetMaxSpeed(bandwidth uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateSetMaxSpeed", 0, bandwidth, flags).Store()
	return
}
...
func (m *Domain) MigrateStartPostCopy(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateStartPostCopy", 0, flags).Store()
	return
}
...
func (m *Domain) MigrateToURI3(dconuri string, params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.MigrateToURI3", 0, dconuri, params, flags).Store()
	return
}
...
func (m *Domain) OpenGraphicsFD(idx uint32, flags uint32) (fd uint32, err error) {
	err = m.conn.object.Call("org.libvirt.Domain.OpenGraphicsFD", 0, idx, flags).Store(&fd)
	return
}
...
func (m *Domain) PinEmulator(cpumap []uint, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.PinEmulator", 0, cpumap, flags).Store()
	return
}
...
func (m *Domain) PinIOThread(iothreadId uint32, cpumap []uint, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.PinIOThread", 0, iothreadId, cpumap, flags).Store()
	return
}
...
func (m *Domain) PinVcpu(vcpu uint32, cpumap []uint, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.PinVcpu", 0, vcpu, cpumap, flags).Store()
	return
}
...
func (m *Domain) PMWakeup(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.PMWakeup", 0, flags).Store()
	return
}

// Reboot See https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainReboot
func (m *Domain) Reboot(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Reboot", 0, flags).Store()
	return
}
...
func (m *Domain) Save(to string, xml string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Save", 0, to, xml, flags).Store()
	return
}
...
func (m *Domain) SendKey(codeset uint32, holdtime uint32, keycodes []uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SendKey", 0, codeset, holdtime, keycodes, flags).Store()
	return
}
...
func (m *Domain) SendProcessSignal(pidValue int64, sigNum uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SendProcessSignal", 0, pidValue, sigNum, flags).Store()
	return
}
...
func (m *Domain) SetBlockIOParameters(params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetBlockIOParameters", 0, params, flags).Store()
	return
}
...
func (m *Domain) SetBlockIOTune(disk string, params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetBlockIOTune", 0, disk, params, flags).Store()
	return
}
...
func (m *Domain) SetGuestVcpus(vcpumap []uint, state int32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetGuestVcpus", 0, vcpumap, state, flags).Store()
	return
}
...
func (m *Domain) SetInterfaceParameters(device string, params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetInterfaceParameters", 0, device, params, flags).Store()
	return
}
...
func (m *Domain) SetMemory(memory uint64, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetMemory", 0, memory, flags).Store()
	return
}
...
func (m *Domain) SetMemoryParameters(params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetMemoryParameters", 0, params, flags).Store()
	return
}
...
func (m *Domain) SetMemoryStatsPeriod(period int32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetMemoryStatsPeriod", 0, period, flags).Store()
	return
}
...
func (m *Domain) SetMetadata(itype int32, metadata string, key string, uri string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetMetadata", 0, itype, metadata, key, uri, flags).Store()
	return
}
...
func (m *Domain) SetNumaParameters(params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetNumaParameters", 0, params, flags).Store()
	return
}
...
func (m *Domain) SetPerfEvents(params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetPerfEvents", 0, params, flags).Store()
	return
}
...
func (m *Domain) SetSchedulerParameters(params map[string]interface{}, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetSchedulerParameters", 0, params, flags).Store()
	return
}
...
func (m *Domain) SetUserPassword(user string, password string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetUserPassword", 0, user, password, flags).Store()
	return
}
...
func (m *Domain) SetTime(seconds uint64, nseconds uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetTime", 0, seconds, nseconds, flags).Store()
	return
}
...
func (m *Domain) SetVcpus(vcpus uint32, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.SetVcpus", 0, vcpus, flags).Store()
	return
}
...
func (m *Domain) Shutdown(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Shutdown", 0, flags).Store()
	return
}

// Suspend See https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainSuspend
func (m *Domain) Suspend() (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Suspend", 0).Store()
	return
}
...
func (m *Domain) Undefine(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.Undefine", 0, flags).Store()
	return
}
...
func (m *Domain) UpdateDevice(xml string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.Domain.UpdateDevice", 0, xml, flags).Store()
	return
}
