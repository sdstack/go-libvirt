...
func (m *NodeDevice) Destroy() (err error) {
	err = m.conn.object.Call("org.libvirt.NodeDevice.Destroy", 0).Store()
	return
}
...
func (m *NodeDevice) Detach(driverName string, flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.NodeDevice.Detach", 0, driverName, flags).Store()
	return
}
...
func (m *NodeDevice) GetXMLDesc(flags uint32) (xml string, err error) {
	err = m.conn.object.Call("org.libvirt.NodeDevice.GetXMLDesc", 0, flags).Store(&xml)
	return
}
...
func (m *NodeDevice) ListCaps() (names []string, err error) {
	err = m.conn.object.Call("org.libvirt.NodeDevice.ListCaps", 0).Store(&names)
	return
}
...
func (m *NodeDevice) ReAttach() (err error) {
	err = m.conn.object.Call("org.libvirt.NodeDevice.ReAttach", 0).Store()
	return
}

// Reset See https://libvirt.org/html/libvirt-libvirt-nodedev.html#virNodeDeviceReset
func (m *NodeDevice) Reset() (err error) {
	err = m.conn.object.Call("org.libvirt.NodeDevice.Reset", 0).Store()
	return
}
