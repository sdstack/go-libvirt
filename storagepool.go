...
func (m *StoragePool) Build(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.Build", 0, flags).Store()
	return
}
...
func (m *StoragePool) Create(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.Create", 0, flags).Store()
	return
}
...
func (m *StoragePool) Delete(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.Delete", 0, flags).Store()
	return
}
...
func (m *StoragePool) Destroy() (err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.Destroy", 0).Store()
	return
}
...
func (m *StoragePool) GetInfo() (info interface{}, err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.GetInfo", 0).Store(&info)
	return
}
...
func (m *StoragePool) GetXMLDesc(flags uint32) (xml string, err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.GetXMLDesc", 0, flags).Store(&xml)
	return
}
...
func (m *StoragePool) ListStorageVolumes(flags uint32) (storageVols []dbus.ObjectPath, err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.ListStorageVolumes", 0, flags).Store(&storageVols)
	return
}
...
func (m *StoragePool) Refresh(flags uint32) (err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.Refresh", 0, flags).Store()
	return
}
...
func (m *StoragePool) StorageVolCreateXML(xml string, flags uint32) (storageVol dbus.ObjectPath, err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.StorageVolCreateXML", 0, xml, flags).Store(&storageVol)
	return
}
...
func (m *StoragePool) StorageVolCreateXMLFrom(xml string, key string, flags uint32) (storageVol dbus.ObjectPath, err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.StorageVolCreateXMLFrom", 0, xml, key, flags).Store(&storageVol)
	return
}
...
func (m *StoragePool) StorageVolLookupByName(name string) (storageVol dbus.ObjectPath, err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.StorageVolLookupByName", 0, name).Store(&storageVol)
	return
}
...
func (m *StoragePool) Undefine() (err error) {
	err = m.conn.object.Call("org.libvirt.StoragePool.Undefine", 0).Store()
	return
}
